    ...
    new Vue({
        ...
        methods: {
            selectAll() {
                ...
                axios({
                    method: "post",
                    url: "http://localhost:8080/system/dimissionSelectServlet"
                }).then(function (resp) {
            ...
            success() {
                this.$confirm('是否通过该请假申请?', '提示', {
                    ...
                    axios({
                        method: "post",
                        url: "http://localhost:8080/system/dimissionUpdateServlet?result=yes",
                        data: this.afl
                    }).then(function (resp) {
            ...
            failure() {
                this.$confirm('是否删除该员工信息?', '提示', {
                    ...
                    axios({
                        method: "post",
                        url: "http://localhost:8080/system/dimissionUpdateServlet?result=no",
                        data: this.afl
                    }).then(function (resp) {
                        location.href = "http://localhost:8080/system/checkDimission.jsp"
                    })
